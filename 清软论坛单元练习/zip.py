...
ALLOW_CHANGED = ['lint.sh', 'app/checkers/user.py', 'tests/test_basic.py', 'tests/test_api.py', 'tests/test_e2e.py', 'zip.py', '实验报告.pdf', '.flake8', 'Dockerfile', 'nginx/app.conf', 'docker-compose.yml'] # noqa: E501
